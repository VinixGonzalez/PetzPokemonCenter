...
export default function QuemSomosPage() {
  return (
    <main className="flex flex-col">
      <SubHeader
        text="Quem Somos"
        subText="A maior rede de tratamento pokémon."
        crumbList={[
          {
            isLast: true,
            path: "/quem-somos",
      ...
      <section
        ...
        className="flex flex-col flex-1 max-w-md gap-4 mx-auto p-8"
      >
        <h2 className="text-lg font-semibold">O Centro Pokémon</h2>
        ...
        <p className="text-base font-medium">Uma tradição de mais de 20 anos</p>
        ...
        <p className="text-base font-medium">O melhor para seu pokémon</p>
        ...
        <p className="text-base font-medium">Alta Tecnologia</p>
